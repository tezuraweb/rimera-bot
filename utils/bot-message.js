...
const defaultValues = {
    ...
    'appeal_youth': 'Подайте обращение в совет молодежи',
    'appeal_medroom': 'Подайте обращение в медпункт',
    'appeal_salary': 'Подайте обращение о заработной плате и расчетах',
    'appeal_workplace': 'Подайте обращение на обслуживание рабочего места',
